...
(function($, undf){
	...
	$.MixItUp.prototype.extend({
		...
		_parsePaginateArgs: function(args){
			var self = this,
				output = {
					command: null,
					animate: self.animation.disable,
					callback: null
				};
	...
	$.MixItUp.prototype.extend({
		...
		paginate: function(){
			...
			self.multiMix({paginate: args.command}, args.callback);
		},
		...
		nextPage: function(){
			...
			self.multiMix({paginate: self._getNextPage()}, args.callback);
		},
		...
		prevPage: function(){
			...
			self.multiMix({paginate: self._getPrevPage()}, args.callback);
		}
	});
